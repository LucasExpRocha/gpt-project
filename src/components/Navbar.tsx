    ...
    <nav className="">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <button
            type="button"
            className="flex items-center rounded-lg text-sm font-medium text-gray-900 hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 hover:scale-105"
            onClick={handleOpenModal}
          >
            <div className="w-[30px]">
              <div className="relative p-1 rounded-sm h-[30px] w-[30px] text-white flex items-center justify-center bg-greenGpt">
                <svg
            ...
            <div className="border-[#19c37d] border-2 border-l-0 h-[30px] rounded-r-md flex">
              <span className="my-auto px-2">ADICIONAR TOKEN</span>
            </div>
          </button>
        </div>
      </div>
