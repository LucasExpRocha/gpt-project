...
export const Header = () => {
  ...
  return (
    <header className="flex justify-between max-w-4xl w-full mx-auto my-2">
      ...
      <Modal closeModal={handleCloseModal} isOpen={isOpen}>
        <textarea
          ...
          defaultValue={`Seguem conceitos do DDD (Domain Driven Design)
    ...
    Você é uma empresa que desenvolve sistemas. O primeiro passo para começar um projeto é o cliente solicitar para você uma proposta comercial. 
        ...
        <button className="rounded bg-red-600 ml-2 bg-opacity-80 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
          Cancelar
        </button>
      </Modal>
    </header>
